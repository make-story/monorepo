 ...
 *
 * @example
 * const getCategoryProdList = (params: TGetParams, apiManager: TApiManager) =>
 *   apiManager.apiGW.get('apis/endpoint', {
 *     params,
 *     paramsSerializer,
 *   })
 */
const paramsSerializer = <P extends {}>(params: P) => qs.stringify(params, { arrayFormatSeparator: ',' });
