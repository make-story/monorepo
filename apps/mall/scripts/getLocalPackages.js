...
// https://github.com/goldstack/goldstack/blob/master/workspaces/templates/packages/app-nextjs-bootstrap/scripts/getLocalPackages.js
...
exports.getLocalPackages = function () {
  const allWorkspaces = getPackages(childProcess.execSync('yarn workspaces list --json').toString());
